<aside class="main-sidebar elevation-4 sidebar-light-primary"  style="overflow-x: hidden;">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item has-treeview">
            <a href="{{ route('admin.saved.index') }}" class="nav-link {{ Route::is('admin.saved.index') ? 'active' : '' }}">
